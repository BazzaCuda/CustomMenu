...
**As of release v2.0.0 you now create your own custom color scheme**
...
Here's a real-life, non-VM, declutted desktop after configuring a fully-stocked `Custom Menu`:
